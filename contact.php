...
<section class="section-1">
        <div class="jumbotron d-flex align-items-center">
            ...
            <div class="container-fluid content">
                <h1 data-aos="fade-right" data-aos-delay="300">Let's get in touch!</h1>
                <h2 data-aos="fade-left" data-aos-delay="300">I'm looking forward to hearing from you.</h2>
            </div>
            <!--container-fluid end-->
        </div>
    </section>
...
<div id="contact">
  ...
  <div class="row" data-aos="fade-up" data-aos-delay="300">
      <div class="col-md-12 text-left">
          <p>Drop me a line!  If you prefer to chat via Phone, Skype, Whatsapp or Zoom head over to the <a href="consultation.php"><strong>consultation</strong></a> page and book some face time with me. I'm always happy to hear from you.</p>
          <p>Some folks like to talk on the phone, <a href="tel:619-964-6678"><strong>619-964-6678</strong></a>. I'm up for that as well.</p>
      </div>
  </div>
    </div>
